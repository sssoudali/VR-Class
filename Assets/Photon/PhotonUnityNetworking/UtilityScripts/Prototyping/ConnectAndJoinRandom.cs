...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class ConnectAndJoinRandom : MonoBehaviourPunCallbacks
    {
        ...
        {
            GameObject.Find("yup").GetComponent<Text>().text = "Connected to Photon";
        ...
        public override void OnJoinRandomFailed(short returnCode, string message)
        {
            ...
            GameObject.Find("yup").GetComponent<Text>().text = "Random Joining Failed";
            PhotonNetwork.JoinRoom("asfar");
        }

        // the following methods are implemented to give you some context. re-implement them as needed.
        public override void OnDisconnected(DisconnectCause cause)
        {
            GameObject.Find("yup").GetComponent<Text>().text = "Disconnected";
            Debug.Log("OnDisconnected(" + cause + ")");
        }
        public override void OnJoinRoomFailed(short returnCode, string message)
        {
            GameObject.Find("yup").GetComponent<Text>().text = "Manauly Room joining also failed";
            Debug.Log(message);
            base.OnJoinRoomFailed(returnCode, message);
        }
        public override void OnJoinedRoom()
        {
            GameObject.Find("yup").GetComponent<Text>().text = "Room Joined. Transferring to Class";
            ...
            //print(PhotonNetwork.CurrentRoom.Name + " is Room Name");
